/**
 * Socle des erreurs métier du contexte Catalog (§3.2, M4).
 *
 ...
 * `CatalogErrorFilter` — qui traduit en réponse HTTP.
 *
...
export abstract class CatalogError extends Error {
  abstract readonly kind: CatalogErrorKind;
