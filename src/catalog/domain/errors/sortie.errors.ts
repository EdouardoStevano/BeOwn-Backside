...
export class SortieIntrouvableError extends CatalogError {
 ...
 */
export class ModeleEconomiqueNonEquityError extends CatalogError {
 ...
 */
export class ProjetNonFinanceError extends CatalogError {
  readonly kind = CatalogErrorKind.INVALID_INPUT;
 ...
 */
export class SortieDejaEnCoursError extends CatalogError {
 ...
 */
export class TransitionSortieInvalideError extends CatalogError {
  readonly kind = CatalogErrorKind.INVALID_INPUT;
...
export class SortieDejaDistribueeError extends CatalogError {
  readonly kind = CatalogErrorKind.CONFLICT;
 ...
 * n'importe quoi.
 */
export class CapitalCibleInexploitableError extends CatalogError {
  readonly kind = CatalogErrorKind.INVALID_INPUT;
...
export class ChampSortieInvalideError extends CatalogError {
  readonly kind = CatalogErrorKind.INVALID_INPUT;
