...
import { CollecteOuverteDomainEvent } from 'src/catalog/domain/events/collecte-ouverte.domain-event';
import { ProjetAnnonceDomainEvent } from 'src/catalog/domain/events/projet-annonce.domain-event';
import {
