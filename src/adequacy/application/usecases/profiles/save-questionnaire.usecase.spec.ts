...
import { ChampProfilInvalideError } from 'src/adequacy/domain/errors';
...
import { ProfessionnelPsfp } from 'src/adequacy/domain/value-objects/classement-psfp.vo';
...
function monter(existant: AdequacyAssessment | null = null) {
  const mocks = {
    ...
    save: jest.fn((p: EvaluationDAdequation) => Promise.resolve(p)),
