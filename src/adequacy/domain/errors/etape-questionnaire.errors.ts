import {
  EtapeQuestionnaire,
  LIBELLE_ETAPE,
} from 'src/adequacy/domain/enums/etape-questionnaire.enum';
 ...
 */
export class EtapeQuestionnaireFermeeError extends AdequacyError {
  readonly kind = AdequacyErrorKind.CONFLICT;
