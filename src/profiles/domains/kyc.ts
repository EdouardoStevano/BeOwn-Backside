 ...
 * clés sont exactement celles publiées avant le découpage — `GET /profiles/kyc/me`,
 * `GET /profiles/kyc/all` et `GET /users/me` renvoient le même JSON.
 */
 ...
 * `PaymentController.startKyc`. Deux naissances, donc deux occasions de
 ...
 * webhooks Stripe du contexte Payments. Les rapatrier ici est le pas suivant ;
