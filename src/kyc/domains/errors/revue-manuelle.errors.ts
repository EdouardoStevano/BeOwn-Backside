import { KycError, KycErrorKind } from './kyc.error';
 ...
 * repris mot pour mot, et `KycErrorFilter` rend le même 409.
 */
export class KycPasEnRevueManuelleError extends KycError {
  readonly kind = KycErrorKind.CONFLICT;
