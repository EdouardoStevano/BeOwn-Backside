...
import { GetKycImagesUseCase } from './usecases/get-kyc-images.usecase';
...
import { StartKycSessionUseCase } from './usecases/start-kyc-session.usecase';
import { ConsultKycSessionUseCase } from './usecases/consult-kyc-session.usecase';
import { HandleIdentityWebhookUseCase } from './usecases/handle-identity-webhook.usecase';
...
import { KycController } from '../presenters/http/kyc.controller';
import {
  KycLegacyPaymentsController,
  KycLegacyProfilesController,
} from '../presenters/http/kyc-legacy.controller';
import { KycValidatedGuard } from '../presenters/guards/kyc-validated.guard';
import { KycErrorFilter } from '../presenters/http/filters/kyc-error.filter';
...
@Module({
  ...
  providers: [
    ...
    { provide: APP_FILTER, useClass: KycErrorFilter },
  ],
  controllers: [
    KycController,
