...
import {
  DeposerPieceUseCase,
  type FaceDeposee,
} from 'src/onboarding/application/usecases/pieces/deposer-piece.usecase';
import { ConsulterDossierDePiecesUseCase } from 'src/onboarding/application/usecases/pieces/consulter-dossier-de-pieces.usecase';
import {
  DeposerPieceDto,
