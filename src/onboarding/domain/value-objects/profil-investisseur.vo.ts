 ...
 *
 * **L'adéquation porte le sien, à l'identique.** Les deux contextes ont besoin
 * de dire au nom de qui la déclaration est faite, et un Value Object partagé
 * aurait rendu l'un dépendant du domaine de l'autre pour la plus petite des
 * raisons (§25). Le doublon coûte quatre-vingts lignes sans comportement ; il
 * n'a pas à être tenu synchronisé, chaque contexte étant libre de faire évoluer
 * le sien — c'est même le but.
 *
