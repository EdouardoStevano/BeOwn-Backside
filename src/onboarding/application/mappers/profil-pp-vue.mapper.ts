 ...
 * source est le contexte Adéquation, qui le publie par son port ; la réponse,
 * elle, ne change pas.
 */
...
export function vueProfilPP(
  ...
  return {
    ...
    // Aucun repli à écrire ici : le port ne rend jamais `null`, parce que sans
    // questionnaire le titulaire **est** non averti — le classement se gagne, il
    // ne se présume pas. Le défaut appartient au contexte qui le calcule, et
    // trois valeurs par défaut réécrites clé par clé pouvaient diverger du
