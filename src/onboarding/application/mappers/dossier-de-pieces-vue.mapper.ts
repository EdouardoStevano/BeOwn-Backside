import {
  DossierDePieces,
  PieceManquante,
} from 'src/onboarding/domain/aggregates/dossier-de-pieces';
import { PieceJustificativeSnapshot } from 'src/onboarding/domain/entities/piece-justificative';
import {
  LIBELLE_PIECE,
  TypePieceJustificative,
} from 'src/onboarding/domain/enums/type-piece-justificative.enum';
import {
  LIBELLE_PIECE_IDENTITE,
  TypePieceIdentite,
} from 'src/onboarding/domain/enums/type-piece-identite.enum';
