import { PieceJustificative } from 'src/onboarding/domain/entities/piece-justificative';
import { DecisionPiece } from 'src/onboarding/domain/value-objects/decision-piece.vo';
