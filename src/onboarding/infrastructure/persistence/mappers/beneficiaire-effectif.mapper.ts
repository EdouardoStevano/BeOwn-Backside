import { BeneficiaireEffectif } from 'src/onboarding/domain/entities/beneficiaire-effectif';
import { CodePays } from 'src/onboarding/domain/value-objects/code-pays.vo';
import { DateNaissance } from 'src/onboarding/domain/value-objects/date-naissance.vo';
import { NomPersonne } from 'src/onboarding/domain/value-objects/nom-personne.vo';
import { PourcentageDetention } from 'src/onboarding/domain/value-objects/pourcentage-detention.vo';
