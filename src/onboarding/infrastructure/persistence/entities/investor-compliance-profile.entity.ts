...
export class InvestorComplianceProfileEntity {
  ...
  // ── Ce qui n'est plus ici : le classement PSFP et la surveillance ──────
  //
  // Six colonnes — `categoriePsfp`, `patrimoineDeclare`, `montantMaxConseille`,
  // `niveauRisque`, `dernierContactAdmin`, `prochainContactDu` — sont parties
  // pour `evaluation_adequation` avec le contexte qui les calcule, et
  // `EvaluationDAdequationATable1785100000000` les a supprimées de cette table.
  // Les redéclarer ici ferait sélectionner à TypeORM des colonnes qui
  // n'existent plus.
