import {
  ...
  ProfilPP,
} from 'src/iam/domain/aggregates/profil-pp';
import { Coordonnees } from 'src/iam/domain/value-objects/coordonnees.vo';
import { EvaluationInvestisseur } from 'src/iam/domain/value-objects/evaluation-investisseur.vo';
import { eprouverUtilisateurId } from 'src/iam/domain/value-objects/identifiant-utilisateur';
import { Identite } from 'src/iam/domain/value-objects/identite.vo';
import { SituationFiscale } from 'src/iam/domain/value-objects/situation-fiscale.vo';
import { SituationProfessionnelle } from 'src/iam/domain/value-objects/situation-professionnelle.vo';
