...
} from 'src/iam/domain/aggregates/profil-pm';
import { CapitalSocial } from 'src/iam/domain/value-objects/capital-social.vo';
import { eprouverUtilisateurId } from 'src/iam/domain/value-objects/identifiant-utilisateur';
import { IdentiteLegale } from 'src/iam/domain/value-objects/identite-legale.vo';
