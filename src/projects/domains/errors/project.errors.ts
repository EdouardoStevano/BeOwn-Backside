 ...
 */
export class ProjetIntrouvableError extends ProjectsError {
 ...
 */
export class SlugProjetDejaPrisError extends ProjectsError {
 ...
 */
export class TransitionStatutProjetInvalideError extends ProjectsError {
 ...
 */
export class ChampProjetInvalideError extends ProjectsError {
  readonly kind = ProjectsErrorKind.INVALID_INPUT;
 ...
 * catalogue.
 */
export class LienPartageInvalideError extends ProjectsError {
  readonly kind = ProjectsErrorKind.NOT_FOUND;
