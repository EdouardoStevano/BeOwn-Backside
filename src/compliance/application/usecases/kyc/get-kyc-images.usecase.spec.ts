...
import type { DossierKycPublie } from 'src/compliance/application/ports/dossier-kyc.query';
import type { KycReportData } from 'src/compliance/application/ports/identity-verification.port';
