 ...
 * | -------------------------- | ------------------------------------------ |
 * | KYC du représentant validé | `InvestorComplianceProfile.peutOperer` (PP) |
 * | KYB de la société valide   | `InvestorComplianceProfile.peutOperer` (PM) |
 *
 ...
 *
 * @param kybValide verdict de `InvestorComplianceProfile.peutOperer()` sur la
