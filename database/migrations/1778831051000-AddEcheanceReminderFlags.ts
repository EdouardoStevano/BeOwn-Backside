...
export class AddEcheanceReminderFlags1778831051000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "echeance" ADD COLUMN "rappelJ7Envoye" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "echeance" ADD COLUMN "rappelJ1Envoye" boolean NOT NULL DEFAULT false`,
    );
  }
